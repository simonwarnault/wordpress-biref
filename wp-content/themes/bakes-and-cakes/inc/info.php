...
function bakes_and_cakes_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo', 'bakes-and-cakes' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/previews/?theme=bakes-and-cakes' ) . '" target="_blank">' . __( 'here', 'bakes-and-cakes' ) . '</a></span><br />';
